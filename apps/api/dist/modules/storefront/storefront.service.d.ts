...
export declare class StorefrontService {
    ...
    constructor(prisma: PrismaService, productosService: ProductosService, categoriasService: CategoriasService, carritosService: CarritosService, pedidosService: PedidosService, clientesService: ClientesService);
    resolverEmpresa(slug: string): Promise<{
        rubro: string | null;
        id: string;
        nombre: string;
    ...
    obtenerProducto(slug: string, productoId: string): Promise<{
        categoria: {
            empresaId: string;
            id: string;
            nombre: string;
    ...
    private obtenerOCrearClienteAnonimo;
    private verificarItemDeSesion;
}
